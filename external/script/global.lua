...
addHotkey('F11', false, false, false, false, true, 'full(1); full(2); full(3); full(4); full(5); full(6); full(7); full(8); setTime(getRoundTime()); debugFlag(1); debugFlag(2); clearConsole()')
addHotkey('i', true, false, false, true, true, 'stand(1); stand(2); stand(3); stand(4); stand(5); stand(6); stand(7); stand(8)')
addHotkey('INSERT', false, false, false, true, false, 'togglePause(); closeMenu()')
addHotkey('INSERT', true, false, false, true, false, 'frameStep()')
addHotkey('DELETE', false, false, false, true, false, 'frameStep()')
