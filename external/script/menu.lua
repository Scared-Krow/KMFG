...
menu.t_valuename = {
	...
	guardmode = {
		{itemname = 'none', displayname = motif.pause_menu.training_pause_menu.menu.valuename.guardmode_none},		--0
		{itemname = 'all', displayname = motif.pause_menu.training_pause_menu.menu.valuename.guardmode_auto},		--1
		{itemname = 'auto', displayname = motif.pause_menu.training_pause_menu.menu.valuename.guardmode_all},		--2
	},
	fallrecovery = {
		{itemname = 'neutral', displayname = motif.pause_menu.training_pause_menu.menu.valuename.recoverymode_neutral}, -- 0
		{itemname = 'back', displayname = motif.pause_menu.training_pause_menu.menu.valuename.recoverymode_back}, -- 1
		{itemname = 'forward', displayname = motif.pause_menu.training_pause_menu.menu.valuename.recoverymode_forward}, -- 2 
		{itemname = 'up', displayname = motif.pause_menu.training_pause_menu.menu.valuename.recoverymode_up}, -- 3
	},
	distance = {
