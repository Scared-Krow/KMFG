...
local motif =
{
	...
	select_info =
	{
		...
		paletteselect = 1, --Ikemen feature
		...
		p1_palmenu_accept_key = 'x&a&y', --Ikemen feature
		p1_palmenu_cancel_key = 'b', --Ikemen feature
		...
		p2_palmenu_accept_key = 'x&a&y', --Ikemen feature
		p2_palmenu_cancel_key = 'b', --Ikemen feature
